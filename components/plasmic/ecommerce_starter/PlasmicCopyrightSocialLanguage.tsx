...
import * as sty from "./PlasmicCopyrightSocialLanguage.module.css"; // plasmic-import: RustRhVB9YUpiY/css
          ...
          defaultContents: (
            <React.Fragment>
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__pf6Jy)}
              >
                <div
                ...
                <div className={classNames(defaultcss.all, sty.box___0St46)}>
                  <Button
                    icons={"only" as const}
                    link2={"http://twitter.com" as const}
                  >
                    <Icon27Icon
                      className={classNames(defaultcss.all, sty.svg__mjAnV)}
                      role={"img"}
                    />
                  </Button>

                  <Button
                    className={classNames("__wab_instance", sty.button___9Xhww)}
                    icons={"only" as const}
                    link2={"http://youtube.com" as const}
                  >
                    <Icon28Icon
                      className={classNames(defaultcss.all, sty.svg__z95S5)}
                      role={"img"}
                    />
                  </Button>

                  <Button
                    className={classNames("__wab_instance", sty.button__wOuz)}
                    icons={"only" as const}
                    link2={"http://pinterest.com" as const}
                  >
                    <Icon29Icon
                      className={classNames(defaultcss.all, sty.svg__wcPmg)}
                      role={"img"}
                    />
                  </Button>
                </div>
              ...
              <Button
                children2={
                  <Icon15Icon
                    className={classNames(defaultcss.all, sty.svg__eGyMw)}
                    role={"img"}
                  />
                }
                className={classNames("__wab_instance", sty.button__pu4K4)}
                icons={"end" as const}
                slot={"English"}
              >
                <Icon15Icon
                  className={classNames(defaultcss.all, sty.svg__kAd9)}
                  role={"img"}
                />
              </Button>
            </React.Fragment>
