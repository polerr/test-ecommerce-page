...
import * as sty from "./PlasmicValue.module.css"; // plasmic-import: tq51gU2wX-A9Kh/css

import Icon9Icon from "./icons/PlasmicIcon__Icon9"; // plasmic-import: Njmrt00Y4fWj6q/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__sLePv, {
          [sty.box__center__sLePv8YEt9]: hasVariant(
            variants,
            "center",
            "center"
          ),
          [sty.box__topBottom__sLePv0Yg64]: hasVariant(
            variants,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(defaultcss.all, sty.box__pWc7O)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon9Icon
                className={classNames(defaultcss.all, sty.svg__rn9Ls)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__dflRw, {
          [sty.box__center__dflRw8YEt9]: hasVariant(
            variants,
            "center",
            "center"
          ),
          [sty.box__withButton__dflRwnNz2I]: hasVariant(
            variants,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant(variants, "withButton", "withButton") ? true : false) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__ktyZe, {
            [sty.box__center__ktyZe8YEt9]: hasVariant(
              variants,
              "center",
              "center"
            ),
            [sty.box__withButton__ktyZenNz2I]: hasVariant(
              variants,
              "withButton",
              "withButton"
            )
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <Button
                children2={
                  <Icon5Icon
                    className={classNames(defaultcss.all, sty.svg__xWxHz)}
                    role={"img"}
                  />
                }
                className={classNames("__wab_instance", sty.button__pedki, {
                  [sty.button__withButton__pedkinNz2I]: hasVariant(
                    variants,
                    "withButton",
                    "withButton"
                  )
